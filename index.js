            ...
            render: function (tokens, idx) {
                if (tokens[idx].nesting === 1) {
                    ...
                    if (name == 'right') {
                        ...
                        rand = Math.random();
                        return '<p><a class="btn btn-link" data-bs-toggle="collapse" href="#md-tips-' + name + '-' + rand + '" role="button" aria-expanded="false" aria-controls="md-tips-' + name + '-' + rand + '">Details</a></p><div class="collapse alert alert-info" id="md-tips-' + name + '">\n';
                    } else {
