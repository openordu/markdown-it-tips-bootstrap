            ...
            render: function (tokens, idx) {
                if (tokens[idx].nesting === 1) {
                    ...
                    if (name == 'right') {
                        ...
                        return '<p><a class="btn btn-link" data-bs-toggle="collapse" href="#md-tips-' + name + '-' + rand + '" role="button" aria-expanded="false" aria-controls="md-tips-' + name + '-' + rand + '">Show Details</a></p><div class="collapse overflow-scroll alert alert-info md-collapseinfo" id="md-tips-' + name + '-' + rand+ '" style="max-height: 200px;">\n';
                    } else {
